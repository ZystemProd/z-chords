...
const guitarEl = document.getElementById("guitar") as HTMLElement | null;
const keySel = document.getElementById("guitarKey") as HTMLSelectElement | null;
const modeSel = document.getElementById("guitarMode") as HTMLSelectElement | null;
const shapeDown = document.getElementById("shapeDown") as HTMLButtonElement | null;
const shapeUp = document.getElementById("shapeUp") as HTMLButtonElement | null;
const shapeValue = document.getElementById("shapeValue") as HTMLElement | null;

let shapeIndex = 0;
let shapeStarts: number[] = [1, 4, 7, 10, 13];
...
function updateShapeUI(): void {
  if (shapeValue) shapeValue.textContent = String(shapeIndex + 1);
}

function normalizeWindowStart(start: number): number {
...
function drawScale(): void {
  ...
  const mode = modeSel.value as keyof typeof SCALE_FORMULAS;
